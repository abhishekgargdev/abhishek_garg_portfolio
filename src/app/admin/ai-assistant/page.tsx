            ...
            <>
              <DialogHeader>
                <DialogTitle className="flex items-center gap-1.5 text-teal-700 dark:text-teal-400 text-lg font-bold">
                  <Brain className="size-5 text-teal-600 dark:text-teal-400 animate-pulse" />
                  Field AI Optimizer
                </DialogTitle>
                <DialogDescription className="text-xs text-zinc-550 dark:text-zinc-400">
                  Suggest professional updates for field: <strong className="text-zinc-800 dark:text-zinc-250 font-semibold">{activeField.name}</strong>
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="space-y-4 text-sm mt-2">
                ...
                <div className="space-y-1">
                  <span className="text-xs font-semibold text-zinc-550 dark:text-zinc-400 uppercase tracking-wide">Current Value</span>
                  <div className="rounded-lg border border-zinc-200 dark:border-zinc-850 bg-zinc-50/50 dark:bg-zinc-950 p-3 text-zinc-700 dark:text-zinc-300 whitespace-pre-wrap max-h-[150px] overflow-y-auto text-xs leading-relaxed">
                ...
                <div className="space-y-1.5 flex flex-col">
                  <label htmlFor="field-instruction-textarea" className="text-xs font-semibold text-zinc-550 dark:text-zinc-400 uppercase tracking-wide">
                ...
                {fieldSuggestion && (
                  <div className="space-y-1 animate-in fade-in duration-300">
                    ...
                    <div className="rounded-lg border border-teal-200 dark:border-teal-900/50 bg-teal-50/10 dark:bg-teal-950/20 p-3 text-zinc-800 dark:text-zinc-200 whitespace-pre-wrap max-h-[150px] overflow-y-auto text-xs leading-relaxed">
